...
public struct Palette
{
	...
	public static Color32 Lighten(Color32 c, float amount)
	{
		return .(
	...
	public static Color32 Darken(Color32 c, float amount)
	{
		return .(
	...
	public static Color32 Desaturate(Color32 c, float amount)
	{
	...
	/// +15% lightness
	public static Color32 ComputeHover(Color32 baseColor) => Lighten(baseColor, 0.15f);
	/// -15% lightness
	public static Color32 ComputePressed(Color32 baseColor) => Darken(baseColor, 0.15f);
	/// -50% saturation, 50% alpha
	public static Color32 ComputeDisabled(Color32 baseColor) => Desaturate(baseColor, 0.5f);
	/// Tint toward accent
	public static Color32 ComputeFocused(Color32 baseColor, Color32 accent)
	{
	...
	public Color32 ResolveState(Color32 baseColor, ControlState state)
	{
		switch (state)
		{
