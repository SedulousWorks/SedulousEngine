...
static class LayoutDemos
{
	public static Panel CreateStackPanel()
	{
		...
		let labelBox = new ColorBox(Color32(60, 60, 80, 255), "Vertical Stack");
		labelBox.Width = 200;
		labelBox.Height = 30;
		...
		let boxA = new ColorBox(Color32(200, 80, 80, 255), "A");
		boxA.Width = 80;
		boxA.Height = 80;
		hStack.AddChild(boxA);

		let boxB = new ColorBox(Color32(80, 200, 80, 255), "B");
		boxB.Width = 100;
		boxB.Height = 80;
		hStack.AddChild(boxB);

		let boxC = new ColorBox(Color32(80, 80, 200, 255), "C");
		boxC.Width = 60;
		boxC.Height = 80;
		hStack.AddChild(boxC);

		let boxD = new ColorBox(Color32(200, 200, 80, 255), "D");
		boxD.Width = 90;
		boxD.Height = 80;
		...
		let box2A = new ColorBox(Color32(200, 100, 150, 255));
		box2A.Width = 120;
		box2A.Height = 50;
		hStack2.AddChild(box2A);

		let box2B = new ColorBox(Color32(100, 200, 150, 255));
		box2B.Width = 120;
		box2B.Height = 50;
		hStack2.AddChild(box2B);

		let box2C = new ColorBox(Color32(150, 100, 200, 255));
		box2C.Width = 120;
		box2C.Height = 50;
		...
		let boxWide1 = new ColorBox(Color32(180, 180, 180, 255));
		boxWide1.Width = 400;
		boxWide1.Height = 40;
		vStack.AddChild(boxWide1);

		let boxWide2 = new ColorBox(Color32(140, 140, 140, 255));
		boxWide2.Width = 350;
		boxWide2.Height = 40;
	...
	public static Panel CreateGrid()
	{
		...
		let footer = new ColorBox(Color32(100, 100, 140, 255), "Footer (spans 3 cols, 80px height)");
	...
	public static Panel CreateCanvas()
	{
		...
		let box1 = new ColorBox(Color32(200, 80, 80, 255), "Left:20, Top:20");
		box1.Width = 150;
		box1.Height = 80;
		...
		let box2 = new ColorBox(Color32(80, 200, 80, 255), "Left:200, Top:50");
		box2.Width = 120;
		box2.Height = 100;
		...
		let box3 = new ColorBox(Color32(80, 80, 200, 255), "Right:20, Top:20");
		box3.Width = 140;
		box3.Height = 90;
		...
		let box4 = new ColorBox(Color32(200, 200, 80, 255), "Left:100, Bottom:30");
		box4.Width = 180;
		box4.Height = 70;
		...
		let box5 = new ColorBox(Color32(200, 80, 200, 255), "Right:50, Bottom:50");
		box5.Width = 100;
		box5.Height = 100;
		...
		let stretched = new ColorBox(Color32(80, 200, 200, 255), "Stretched (L:20, R:20)");
		stretched.Height = 40;
	...
	public static Panel CreateDockPanel()
	{
		...
		let header = new ColorBox(Color32(80, 80, 140, 255), "Header (Top)");
		header.Height = 60;
		DockPanelProperties.SetDock(header, .Top);
		dock.AddChild(header);

		let footer = new ColorBox(Color32(80, 100, 140, 255), "Footer (Bottom)");
		footer.Height = 50;
		DockPanelProperties.SetDock(footer, .Bottom);
		dock.AddChild(footer);

		let leftSidebar = new ColorBox(Color32(140, 80, 80, 255), "Left");
		leftSidebar.Width = 120;
		DockPanelProperties.SetDock(leftSidebar, .Left);
		dock.AddChild(leftSidebar);

		let rightPanel = new ColorBox(Color32(140, 100, 80, 255), "Right");
		rightPanel.Width = 100;
		DockPanelProperties.SetDock(rightPanel, .Right);
		dock.AddChild(rightPanel);

		let content = new ColorBox(Color32(80, 140, 80, 255), "Content (Fill)");
	...
	public static Panel CreateWrapPanel()
	{
		...
		AddWrapItem(wrap, Color32(200, 80, 80, 255), 80, 60);
		AddWrapItem(wrap, Color32(80, 200, 80, 255), 110, 80);
		AddWrapItem(wrap, Color32(80, 80, 200, 255), 140, 60);
		AddWrapItem(wrap, Color32(200, 200, 80, 255), 80, 80);
		AddWrapItem(wrap, Color32(200, 80, 200, 255), 110, 60);
		AddWrapItem(wrap, Color32(80, 200, 200, 255), 140, 80);
		AddWrapItem(wrap, Color32(180, 120, 80, 255), 80, 60);
		AddWrapItem(wrap, Color32(120, 180, 80, 255), 110, 80);
		AddWrapItem(wrap, Color32(80, 120, 180, 255), 140, 60);
		AddWrapItem(wrap, Color32(180, 80, 120, 255), 80, 80);
		AddWrapItem(wrap, Color32(120, 80, 180, 255), 110, 60);
		AddWrapItem(wrap, Color32(80, 180, 120, 255), 140, 80);
		AddWrapItem(wrap, Color32(160, 160, 80, 255), 80, 60);
		AddWrapItem(wrap, Color32(160, 80, 160, 255), 110, 80);
		AddWrapItem(wrap, Color32(80, 160, 160, 255), 140, 60);

		container.AddChild(wrap);
		return container;
	}

	private static void AddWrapItem(WrapPanel wrap, Color32 color, float width, float height)
	{
	...
	public static Panel CreateSplitPanel()
	{
		...
		outerSplit.SplitterColor = Color32(60, 60, 70, 255);

		let leftPanel = new ColorBox(Color32(100, 80, 80, 255), "Left Panel");
		...
		innerSplit.SplitterColor = Color32(60, 60, 70, 255);

		let topRight = new ColorBox(Color32(80, 100, 80, 255), "Top Right");
		innerSplit.AddChild(topRight);

		let bottomRight = new ColorBox(Color32(80, 80, 100, 255), "Bottom Right");
