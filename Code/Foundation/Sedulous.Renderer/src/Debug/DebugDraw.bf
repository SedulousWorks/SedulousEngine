...
public class DebugDraw
{
	...
	public void DrawLine(Vector3 from, Vector3 to, Color color, bool overlay = false)
	{
		...
		list.Add(.(from, color.ToColor32()));
		list.Add(.(to, color.ToColor32()));
	}
	...
	{
		mOverlayLineVerts.Add(.(from, color.ToColor32()));
		mOverlayLineVerts.Add(.(to, color.ToColor32()));
	}
	...
	public void DrawAxis(Matrix transform, float size = 1.0f, bool overlay = false)
	{
		...
		DrawLine(o, o + x * size, .Red, overlay);
		DrawLine(o, o + y * size, .Green, overlay);
		DrawLine(o, o + z * size, .Blue, overlay);
	}
