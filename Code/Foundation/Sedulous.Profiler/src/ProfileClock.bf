...
///
/// Microseconds rather than Raptor's nanoseconds, because that is the finest thing corlib
/// exposes portably. It is enough for frame scopes, but it does mean a short scope can
/// measure zero and that a parent and its first child routinely share a start tick, which
/// is why the report orders by depth as well as by time.
