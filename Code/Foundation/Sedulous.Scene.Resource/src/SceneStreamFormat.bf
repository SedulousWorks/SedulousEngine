...
///
/// ONE format: nothing was ever written in an older one, so this reads and writes the
/// current form only and refuses anything else by name. A version field stays in the
