...
public class SolidBrush : IBrush
{
	...
	/// Implicit conversion from Color to SolidBrush.
	/// Enables passing a Color value wherever an IBrush is expected.
	public static implicit operator SolidBrush(Color color)
	{
	...
	public static readonly SolidBrush Transparent = new .(Color.Transparent) ~ delete _;
}
