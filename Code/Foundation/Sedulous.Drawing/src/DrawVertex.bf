...
public struct DrawVertex
{
	...
	public static DrawVertex Solid(Vector2 position, Color32 color, Vector2 whitePixelUV = default)
	{
		return .(position, whitePixelUV, color);
	}

	/// Create a vertex with no texture (uses white pixel UV)
	public static DrawVertex Solid(float x, float y, Color32 color, Vector2 whitePixelUV = default)
	{
