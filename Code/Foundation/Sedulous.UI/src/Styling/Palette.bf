...
public static class Palette
{
	...
	public static Color32 ComputeFocused(Color32 baseColor, Color32 accentColor = .(60, 130, 220, 255))
	{
		return .(
	...
	public static StateListDrawable CreateStateColors(Color32 baseColor)
	{
	...
	public static StateListDrawable CreateStateRounded(Color32 baseColor, Sedulous.VG.CornerRadii radii)
	{
		let sl = new StateListDrawable();
