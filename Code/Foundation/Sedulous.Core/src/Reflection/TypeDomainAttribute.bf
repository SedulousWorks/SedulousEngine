...
/// have.
///
/// An OPEN SET named by string, not an enum: a layer that did not exist when this was
/// written can name its own domain without editing Core. [[ScriptDomains]] holds the names
/// Core itself knows.
///
...
/// out the editor's types, and let a browser mark what it shows. Tooling reads it and
/// runtime behaviour never depends on it.
