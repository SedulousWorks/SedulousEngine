...
struct GraphicsDeviceDesc
{
	...
	///
	/// ON here, because Beef has no release define to switch on the way Raptor's
	/// BUILD_RELEASE does. A shipping host sets it false itself, which is the same
	/// decision made one level up rather than by the build type.
