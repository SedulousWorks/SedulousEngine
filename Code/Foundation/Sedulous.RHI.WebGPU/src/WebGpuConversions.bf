...
static class WebGpuConversions
{
	...
	/// colour target. Depth and stencil, the block compressed formats, and the packed
	/// ones WebGPU cannot render are all out.
	public static bool IsBlitCapableFormat(TextureFormat format)
	{
		...
		case .Undefined,
			...
			.RGBA16Unorm, .RGBA16Snorm, .RGB9E5Float, .RG11B10Float:
			return false;
		default:
			return true;
		}
