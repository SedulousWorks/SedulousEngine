...
class Program
{
	public static int Main(String[] args)
	{
		...
		windowSettings.Title = "Game UI Sandbox";
		...
		{
			Console.Error.WriteLine("GameUiSandbox: the shell has no main window");
			return 1;
		}
		...
		{
			Console.Error.WriteLine("GameUiSandbox: the graphics device could not be created");
			return 1;
		}
		defer delete graphics;

		let app = scope GameUiSandboxApp();
