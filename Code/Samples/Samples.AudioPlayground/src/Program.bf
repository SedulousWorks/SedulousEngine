...
class Program
{
	public static int Main(String[] args)
	{
		...
		windowSettings.Title = "Audio Playground";
		...
		{
			Console.Error.WriteLine("AudioPlayground: the shell has no main window");
			return 1;
		}
		...
		{
			Console.Error.WriteLine("AudioPlayground: the graphics device could not be created");
			return 1;
		}
		defer delete graphics;

		let app = scope AudioPlaygroundApp();
