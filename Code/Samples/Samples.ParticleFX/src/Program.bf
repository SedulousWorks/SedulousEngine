...
class Program
{
	public static int Main(String[] args)
	{
		...
		windowSettings.Title = "ParticleFX";
		...
		{
			Console.Error.WriteLine("ParticleFX: the shell has no main window");
			return 1;
		}
		...
		{
			Console.Error.WriteLine("ParticleFX: the graphics device could not be created");
			return 1;
		}
