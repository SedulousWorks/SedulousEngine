...
class Program
{
	public static int Main(String[] args)
	{
		...
		windowSettings.Title = "Animated Crowd";
		...
		{
			Console.Error.WriteLine("AnimatedCrowd: the shell has no main window");
			return 1;
		}
		...
		{
			Console.Error.WriteLine("AnimatedCrowd: the graphics device could not be created");
			return 1;
		}
		defer delete graphics;

		let app = scope AnimatedCrowdApp();
