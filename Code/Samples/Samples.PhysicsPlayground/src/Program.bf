...
class Program
{
	public static int Main(String[] args)
	{
		...
		windowSettings.Title = "Physics Playground";
		...
		{
			Console.Error.WriteLine("PhysicsPlayground: the shell has no main window");
			return 1;
		}
		...
		{
			Console.Error.WriteLine("PhysicsPlayground: the graphics device could not be created");
			return 1;
		}
		defer delete graphics;

		let app = scope PhysicsPlaygroundApp();
