...
class Program
{
	public static int Main(String[] args)
	{
		...
		windowSettings.Title = "Hello Window";
		...
		{
			Console.Error.WriteLine("HelloWindow: the shell has no main window");
			return 1;
		}
		...
		{
			Console.Error.WriteLine("HelloWindow: the graphics device could not be created");
			return 1;
		}
		defer delete graphics;

		let app = scope HelloWindowApp();
