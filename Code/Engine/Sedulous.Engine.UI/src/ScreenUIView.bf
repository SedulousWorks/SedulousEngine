...
/// Called by EngineUISubsystem.Render (which forwards from
/// IScreenRenderer's shared render pass) to composite UI onto the
/// swapchain. The render pass is bound by the screen renderer; this
