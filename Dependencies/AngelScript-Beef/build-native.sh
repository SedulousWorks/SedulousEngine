#!/usr/bin/env bash
# Linux counterpart of build-native.ps1. Builds libangelscript.a and the C shim libangelscript_beef.a, and copies both to dist/.
set -euo pipefail
cd "$(dirname "$0")"
SRC="."
LIBS=("libangelscript_beef.a" "libangelscript.a")
