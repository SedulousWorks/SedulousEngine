...
public static class StyleValueParser
{
	...
	/// Parse a named color (white, black, transparent, red, green, blue).
	...
	/// Parse a thickness value from 1, 2, or 4 floats.
	/// "8" -> all sides 8
	/// "8 12" -> vertical 8, horizontal 12
	/// "8 12 8 12" -> top, right, bottom, left
